...
verdiWindowResize -win $_vdCoverage_1 "574" "226" "992" "709"
...
verdiWindowResize -win $_vdCoverage_1 "574" "226" "1024" "709"
gui_covtable_show -show  { Function Groups } -id  CoverageTable.1  -test  MergedTest
...
gui_list_select -id CovDetail.1 -list Cover { Assertions  {Cover sequences}   } -type { {} {}  }
...
gui_list_action -id  CoverageTable.1 -list {covtblFGroupsList} {/$unit::uart_coverage::cg_data}  -column {} 
vdCovExit -noprompt
